...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "settings.oauth_token": "OAuth Token (Max 订阅，优先)",
    "settings.api_key": "API 密钥",
    "settings.base_url": "自定义网关地址 (可选)",
    "settings.model": "模型",
    "settings.platforms_config": "构建平台",
    "settings.target_platforms": "目标平台 (可多选)",
    "settings.platform_android": "安卓 Android",
    "settings.platform_ios": "苹果 iOS",
    "settings.platform_ohos": "鸿蒙 HarmonyOS",
    ...
    "settings.output_config": "输出与 GitHub 配置",
    "settings.output_dir": "本地输出目录",
    "settings.github_org": "GitHub 组织/用户",
    ...
    "settings.agc_client_id": "AGC Client ID（鸿蒙上架）",
    "settings.agc_client_secret": "AGC Client Secret（鸿蒙上架）",
    "settings.agc_app_id": "AGC App ID（鸿蒙应用）",
  ...
  en: {
    ...
    "settings.oauth_token": "OAuth Token (Max plan, preferred)",
    "settings.api_key": "API Key",
    "settings.base_url": "Custom Gateway URL (optional)",
    "settings.model": "Model",
    "settings.platforms_config": "Build Platforms",
    "settings.target_platforms": "Target Platforms (multi-select)",
    "settings.platform_android": "Android",
    "settings.platform_ios": "iOS",
    "settings.platform_ohos": "HarmonyOS",
    ...
    "settings.output_config": "Output & GitHub Configuration",
    "settings.output_dir": "Local Output Directory",
    "settings.github_org": "GitHub Organization/User",
    ...
    "settings.agc_client_id": "AGC Client ID (HarmonyOS publish)",
    "settings.agc_client_secret": "AGC Client Secret (HarmonyOS publish)",
    "settings.agc_app_id": "AGC App ID (HarmonyOS app)",
